      ...
      <div className="flex  flex-col justify-center items-center  h-screen">
        <div className="flex justify-center items-center bg-white rounded-md mb-10 ">
          <div className="flex flex-col  m-10 ">
            ...
            <p className="text-base font-light px-2">to access user detailes</p>
            <input
              type="text"
            ...
            />
            {error ? (
              <p className="text-xs font-bold px-2 text-red-500">
            ...
            {/* <button
              className="text-base font-semibold px-2 text-buttonColor text-right"
            ...
            <div className="flex flex-col justify-center items-center mt-2">
              ...
              <p className="text-base font-light ">Email : agent@gmail.com</p>
              <p className="text-base font-light ">Password : agent123</p>
            </div>
          </div>
        </div>
      </div>
